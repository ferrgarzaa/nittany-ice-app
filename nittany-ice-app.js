    ...
    return html`
      <section class="section">
        ...
        <div class="grid-3">
          <nittany-ice-program-card
            icon="◐"
            title="Couch to 5K (Trail)"
            text="A friendly, ten-week intro to trail running. No experience required — just a willingness to walk a few hills."
            link="?page=join"
            linktext="Sign up"
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            ...
            text="Twelve weeks of structured training for your first or fastest trail half. Long runs, hill work, and recovery."
            link="?page=join"
            linktext="Sign up"
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="❖"
            title="Ultra Foundations"
            text="Sixteen weeks of base building for the Wildhorn 50K Ultra. Back-to-back long runs, fueling, and pacing strategy."
            link="?page=join"
            linktext="Sign up"
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="◇"
            title="Wednesday Night Runs"
            text="Free weekly group runs leaving from Cedar Hollow Trailhead at 6pm. All paces welcome — no one runs alone."
            link="?page=schedule"
            linktext="See dates"
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            ...
            text="Distances from 8 to 22 miles, organized by pace group. Coffee and pastries at the trailhead afterward."
            link="?page=schedule"
            linktext="See dates"
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="◯"
            title="Strength for Trail"
            text="Weekly mobility and strength sessions designed for trail runners. Improve your descents and stay injury-free."
            link="?page=join"
            linktext="Sign up"
          ></nittany-ice-program-card>
        </div>
    ...
    return html`
      <section class="section">
        ...
        <div class="grid-2">
          <nittany-ice-program-card
            icon="❖"
            title="Mountain Cubs (ages 6–12)"
            text="Weekly skills sessions, scavenger hunts, and fun trail runs in a safe, supportive group setting. No racing required."
            link="?page=join"
            linktext="Enroll"
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="✦"
            title="Junior Wildhorn (ages 13–17)"
            text="Structured training for young athletes interested in racing. Includes coaching, mentorship, and free entry to youth races."
            link="?page=join"
            linktext="Enroll"
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="◐"
            title="Family trail days"
            text="One Saturday a month, the whole family comes out. Easy distances, picnics, and a chance to meet other trail families."
            link="?page=schedule"
            linktext="See dates"
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            ...
            text="Lend a hand at races, training runs, or trail cleanups. Background checks and safety training provided."
            link="?page=volunteer"
            linktext="Volunteer"
          ></nittany-ice-program-card>
        </div>
      ...
      <nittany-ice-cta
        ...
        copy="Enrollment for the 2026 youth season is open. Scholarship spots are available — no family is turned away for financial reasons."
      ...
      <section class="section">
        ...
        <div class="grid-3">
          <nittany-ice-program-card
            icon="◐"
            title="Our founder"
            text="Fernanda Garza Martinez — marathoner, ultramarathoner, and lifelong runner who traded the pavement for ridgelines and never looked back."
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="✦"
            title="Our values"
            text="Trail stewardship, community over competition, accessibility, and the belief that every runner belongs."
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="❖"
            title="Our community"
            text="A growing 1,200+ member community logging stewardship hours, awarding youth scholarships, and showing up for each other on every trail."
          ></nittany-ice-program-card>
        </div>
      </section>
    `;
      ...
      <section class="section">
        ...
        <div class="grid-2">
          <nittany-ice-program-card
            ...
            text="Email us at hello@wildhorntra.org and we will get back to you within two business days."
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="✦"
            title="Race & registration"
            text="Questions about a specific race or your registration? Email races@wildhorntra.org for the fastest response."
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="❖"
            title="Youth programs"
            text="Reach our youth program director at youth@wildhorntra.org for enrollment, scholarships, and family questions."
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="◇"
            title="Volunteer & stewardship"
            text="Want to help out at races or on the trails? Email volunteer@wildhorntra.org to get on the list."
          ></nittany-ice-program-card>
        </div>
      </section>
    `;
    ...
    return html`
      <section class="section">
        ...
        <div class="grid-3">
          <nittany-ice-program-card
            icon="◐"
            title="Individual — $45/yr"
            text="Priority race registration, race discounts, weekly group runs, training plan discounts, and a welcome pack."
            link="?page=contact"
            linktext="Sign up"
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="✦"
            title="Family — $75/yr"
            text="Everything in the individual plan, for two adults and up to three youth runners. Includes Mountain Cubs enrollment."
            link="?page=contact"
            linktext="Sign up"
          ></nittany-ice-program-card>
          <nittany-ice-program-card
            icon="❖"
            title="Steward — $150/yr"
            text="All member benefits plus a tax-deductible donation that funds youth scholarships and trail stewardship."
            link="?page=contact"
            linktext="Sign up"
          ></nittany-ice-program-card>
        </div>
